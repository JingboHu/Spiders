...
class hackTickets(object):
    ...
    def readConfig(self, config_file='config.ini'):
        ...
        try:
            ...
            Log.write('打开配置文件"%s"失败, 请先创建或者拷贝一份配置文件config.ini\n')
    ...
    def convertCityToCode(self, c):
        try:
            ...
            Log.write("转换城市错误，请修改config.ini中starts或者ends值为中文城市名\n")
            return False
    ...
    def searchMore(self):
        ...
        if self.start_time:
            ...
            Log.write("未指定发车时间，默认00:00-24:00\n")
